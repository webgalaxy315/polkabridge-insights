...
export default function DEFIBasics() {
        ...
        <div>
            ...
            <div className="flex">
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Rectangle 33 (2).png" />
                ...
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Article_Image (3).png" />
                    <div className="flex my-4">
                        <span className="text-white text-sm mr-8">Fantasy</span>
                        <span className="text-white text-sm mr-8">·</span>
                        <span className="text-white text-sm">1 Month Ago </span>
                ...
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Rectangle 34 (2).png" />
                    <div className="flex my-4">
                        <span className="text-white text-sm mr-8">Fantasy</span>
                        <span className="text-white text-sm mr-8">·</span>
                        <span className="text-white text-sm">1 Month Ago </span>
            ...
            <div className="flex">
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Rectangle 33-1.png" />
                    <div className="flex my-4">
                        <span className="text-white text-sm mr-8">Fantasy</span>
                        <span className="text-white text-sm mr-8">·</span>
                        <span className="text-white text-sm">1 Month Ago </span>
                ...
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Article_Image-1.png" />
                    <div className="flex my-4">
                        <span className="text-white text-sm mr-8">Fantasy</span>
                        <span className="text-white text-sm mr-8">·</span>
                        <span className="text-white text-sm">1 Month Ago </span>
                ...
                <div className="mx-8 my-8 border border-slate-800 rounded-lg px-4 py-4">
                    <img src="/home/Rectangle 34-1.png" />
                    <div className="flex my-4">
                        <span className="text-white text-sm mr-8">Fantasy</span>
                        <span className="text-white text-sm mr-8">·</span>
                        <span className="text-white text-sm">1 Month Ago </span>
